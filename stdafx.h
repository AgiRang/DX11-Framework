...
#include"./Singleton/KirbyManager.h"
#define KIRBYMANAGER KirbyManager::GetInstance()
#define KIRBY KirbyManager::GetInstance()->GETKIRBY()
#include"./Singleton/gunterManager.h"
#define gunterMANAGER gunterManager::GetInstance()
#define GUNTER gunterManager::GetInstance()->GETGUNTER()
